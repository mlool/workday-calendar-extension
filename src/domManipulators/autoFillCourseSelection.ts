...
const getAutomationLabel = (session: string) => {
  switch (session) {
    case "2029W":
      return [
        "2029-30 UBC-V Academic Year",
        "2029-30 Winter Term 1 (UBC-V)",
        "2029-30 Winter Term 2 (UBC-V)",
      ];
    case "2029S":
      return ["2028-29 UBC-V Academic Year", "2028-29 Summer Session (UBC-V)"];
    case "2028W":
      return [
        "2028-29 UBC-V Academic Year",
        "2028-29 Winter Term 1 (UBC-V)",
        "2028-29 Winter Term 2 (UBC-V)",
      ];
    case "2028S":
      return ["2027-28 UBC-V Academic Year", "2028 Summer Session (UBC-V)"];
    case "2027W":
      return [
        "2027-28 UBC-V Academic Year",
        "2027-28 Winter Term 1 (UBC-V)",
        "2027-28 Winter Term 2 (UBC-V)",
      ];
    case "2027S":
      return ["2026-27 UBC-V Academic Year", "2027 Summer Session (UBC-V)"];
    case "2026W":
      return [
        "2026-27 UBC-V Academic Year",
    ...
    case "2023W":
      return [
        "2023-24 UBC-V Academic Year",
        "2023-24 Winter Term 1 (UBC-V)",
        "2023-24 Winter Term 2 (UBC-V)",
      ];
    case "2023S":
