...
import { getAllSavedScheduleIDs, addCoursesToSavedSchedule } from "./syncSavedSchedulesHelper";
...
const SyncSavedSchedules = (props: IProps) => {
  ...
  const beginSync = async () => {
    ...
    if (scheduleID) {
      ...
      alert(`No saved schedule was detected. The most likely issue is that you are not on the "View My Saved Schedules" page. Please head to that page and try again.`)
    }
  };
